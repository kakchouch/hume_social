---
title: "Moderation App Reference"
---

# Moderation App Reference

Source folder: `src/apps/moderation`
...
- Source: `src/apps/moderation/apps.py`

## Models

### EditorialReview

- Source: `src/apps/moderation/models.py`
...
- Source: `src/apps/moderation/urls.py`
