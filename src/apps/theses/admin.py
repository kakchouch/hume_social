...
class MiniThesisAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'id', 'author', 'thesis_truncated', 'rigor_score',
...
class CommentAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'id', 'author', 'thesis_truncated', 'content_truncated', 'created_at'
    )
...
class CitationAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'id', 'citing_thesis_truncated', 'cited_thesis_truncated', 'context_truncated'
    )
