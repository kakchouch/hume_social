...
class MiniThesisForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "normative_premises": forms.Textarea(
                attrs={
                    "rows": 4,
            ...
            "declared_limits": forms.Textarea(
                attrs={
                    "rows": 3,
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk and self.instance.normative_premises:
            ...
            ].initial = self.instance.normative_premises
    ...
    def clean_selected_text(self):
        ...
        if not selected_text:
            raise forms.ValidationError(
                "Select part of the thesis text before submitting a review highlight."
            )
