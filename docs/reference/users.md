...
Source folder: [../../src/apps/users](../../src/apps/users)
...
- Source: [../../src/apps/users/apps.py](../../src/apps/users/apps.py)
- Purpose: Registers the app as `apps.users`.
- Related: [Theses App](theses.md), [Feed App](feed.md)

## Models

### User (inherits AbstractUser)

- Source: [../../src/apps/users/models.py](../../src/apps/users/models.py)
...
- Used by [MiniThesis](theses.md#minithesis)
- Used by [TagApplication](tags.md#tagapplication)
- Used by [EditorialReview](moderation.md#editorialreview)
- Used by [Sponsorship](sponsorship.md#sponsorship)
...
- Source: [../../src/apps/users/forms.py](../../src/apps/users/forms.py)
...
Source: [../../src/apps/users/views.py](../../src/apps/users/views.py)

### landing_page(request)

- Renders: [../../templates/index.html](../../templates/index.html)
- Parameters: `request`
- Context keys: `signup_form`, `feed_items`, `min_rigor_threshold`
- Related: [FeedItem.calculate_scores](feed.md#feeditem)

### user_list(request)

- Renders: [../../templates/users/user_list.html](../../templates/users/user_list.html)
- Query params: `q`
- Context keys: `users`, `search_query`

### user_detail(request, pk)

- Renders: [../../templates/users/user_detail.html](../../templates/users/user_detail.html)
...
- Renders: [../../templates/users/contact_requests.html](../../templates/users/contact_requests.html)
...
- Renders: [../../templates/users/sponsorship_requests.html](../../templates/users/sponsorship_requests.html)
...
- Renders: [../../templates/users/my_profile.html](../../templates/users/my_profile.html)
- Context keys: `form`, `profile_user`, `sponsored_users`, `contacts`

### delete_account(request)

- Renders: [../../templates/users/delete_account_confirm.html](../../templates/users/delete_account_confirm.html)
- Redirects to: [../../templates/users/account_deleted.html](../../templates/users/account_deleted.html)

### account_deleted(request)

- Renders: [../../templates/users/account_deleted.html](../../templates/users/account_deleted.html)
...
- Source: [../../src/apps/users/urls.py](../../src/apps/users/urls.py)
- Namespace: `users`
...
- [Template contracts](templates.md)
