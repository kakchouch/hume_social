...
Source folder: [../../src/apps/theses](../../src/apps/theses)
...
- Source: [../../src/apps/theses/apps.py](../../src/apps/theses/apps.py)
...
- Source: [../../src/apps/theses/models.py](../../src/apps/theses/models.py)
...
- Author is [User](users.md#user-inherits-abstractuser)
- Reviews are [EditorialReview](moderation.md#editorialreview)
- Tags are [TagApplication](tags.md#tagapplication)
- Feed scoring uses [FeedItem.calculate_scores](feed.md#feeditem)
...
Source: [../../src/apps/theses/forms.py](../../src/apps/theses/forms.py)
...
Source: [../../src/apps/theses/views.py](../../src/apps/theses/views.py)
...
- Renders: [../../templates/theses/thesis_list.html](../../templates/theses/thesis_list.html) and HTMX fragment [../../templates/theses/_thesis_cards.html](../../templates/theses/_thesis_cards.html)
- Query params: `q`, `page`
- Context keys: `page_obj`, `search_query`, `can_write_theses`

### thesis_detail(request, pk)

- Renders: [../../templates/theses/thesis_detail.html](../../templates/theses/thesis_detail.html)
...
- Renders: [../../templates/theses/thesis_review.html](../../templates/theses/thesis_review.html)
- Parameters: `request`, `pk`
- Actions:
...
- Renders: [../../templates/theses/thesis_form.html](../../templates/theses/thesis_form.html)
...
- Source: [../../src/apps/theses/urls.py](../../src/apps/theses/urls.py)
